...
/********************************************************************/
// 1、原始数据
var originDataPath = './tempdata/3-downloadPage.txt'
// 2、存储当前已经搜索到的有效位置
var storagePath = './storage/5-finalDataHistory.txt'
// 3、将结果写入的文件的路径
var filePath = './tempdata/5-finalData.txt'
...
/********************************************************************/
// 初始化请求url
var initialurl = encodeURI(useArr[searchCount].dlink)
                ...
                page.includeJs("https://cdn.bootcss.com/jquery/1.11.3/jquery.min.js", function() {
                    ...
                    if (content) {
                        ...
                        for (var key in content) {
                            useArr[searchCount].apkUrl = content
                        }
...
function changeSearchWord(searchWordIndex) {
    var initialurl = encodeURI(useArr[searchWordIndex].dlink)
    return initialurl;
}
