...
// 2、存储当前已经搜索到的有效位置
var storagePath = './storage/4-downloadNumHistory.txt'
// 3、将结果写入的文件的路径
var filePath = './tempdata/4-downloadNum.txt'
...
/********************************************************************/
// 初始化请求url
var initialurl = encodeURI(useArr[searchCount].downTotalLink)
        ...
        if (status !== 'success') {
            ...
            window.setTimeout(function() {
                ...
                page.includeJs("https://cdn.bootcss.com/jquery/1.11.3/jquery.min.js", function() {
                    ...
                    if (content) {
                        reTryCount = 1;
                        useArr[searchCount].totalDownloadNum = content
...
function changeSearchWord(searchWordIndex) {
    var initialurl = encodeURI(useArr[searchWordIndex].downTotalLink)
    return initialurl;
}
